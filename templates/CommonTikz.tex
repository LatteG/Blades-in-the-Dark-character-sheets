...
\def\TraumaX{5.717cm}
\def\TraumaY{-7.265cm}
\def\TraumaWidth{0.212cm}
\def\TraumaLeftHeight{0.4cm}
\def\TraumaRightHeight{0.3cm}
\def\TraumaGap{0.352cm}
...
%% Handle extra stress box from crew upgrade
\IfSubStr{\CrewUpgrades}{stress box}{%
    \def\StressX{2.096cm}
    \def\StressW{0.2cm}
    \def\StressGap{0.344cm}
    \def\StressTriangleH{0.075cm}
    \def\StressTriangleW{0.155cm}
    
    \draw[black] (\StressX, \TraumaY) 
              -- (\StressX + \StressW, \TraumaY) 
              -- (\StressX + \StressW, \TraumaY - \TraumaRightHeight) 
              -- (\StressX, \TraumaY - \TraumaLeftHeight) 
              -- cycle;
              
    \fill[black] (\StressX, \TraumaY)
              -- (\StressX + \StressTriangleW, \TraumaY)
              -- (\StressX, \TraumaY - \StressTriangleH)
              -- cycle;
}{}
